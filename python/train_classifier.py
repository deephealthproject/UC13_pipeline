...
from data_utils import EEGDataGenerator
from evaluation_utils import calculate_fpr
#from data_utils_eeg import PairDataGenerator
from models_01 import model_classifier_1a, model_classifier_2a, model_classifier_4a
...
if __name__ == '__main__':
    ...
    dg = EEGDataGenerator(batch_size = batch_size,
                            do_shuffle = True,
                            load_stats = False,
                            mode = 'train',
    ...
    for fold in range(dg.num_seizures):
        ...
        if model_id == '1a':
            ...
            net = model_classifier_4a(input_shape, num_classes = 2, filename = model_filename)
        else:
            raise Exception('You have to indicate a model id!')
        #
